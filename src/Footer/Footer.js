            ...
            <div className="row justify-content-start">
                ...
                <div className="col-lg-3 ml-lg-auto col-sm-12">
                    <div className="footer-widget text-white">
                        ...
                        <Nav.Link as={Link} to="/home"  className="py-0 text-secondary">TPrivacy Policy</Nav.Link>
                ...
                <div className="col-lg-2 col-sm-6">
                    <div className="footer-widget text-white">
                        ...
                        <Nav.Link as={Link} to="/home"  className="py-0 text-secondary">About Us</Nav.Link>
